                        ...
                        <div className="grid gap-2">
                            ...
                            >
                                <Label
                                    ...
                                    className={`flex min-h-36 cursor-pointer flex-col rounded-lg border p-4 transition-colors ${role === 'cooperative'
                                ...
                                >
                                    ...
                                    <span className="mt-3 text-sm font-black leading-tight">Koperasi</span>
                                ...
                                <Label
                                    htmlFor="role-buyer"
                                    className={`flex min-h-36 cursor-pointer flex-col rounded-lg border p-4 transition-colors ${role === 'buyer'
                                        ? 'border-emerald-700 bg-emerald-50 text-slate-950'
                                        : 'border-slate-200 bg-slate-50 text-slate-800 hover:border-slate-300'
                                        }`}
                                >
                                    ...
                                    <span className="mt-3 text-sm font-black leading-tight">Mitra Buyer (Offtaker)</span>
                                    <span className="mt-3 text-xs font-normal leading-relaxed text-slate-500">
